...
- [-] F2.5 Permitir reorganizar a ordem das cenas
  Notas: A ordem ja pode ser reorganizada com controles de subir/descer em cenas e subcenas; `RPG-100` estendeu esse controle para beats. Ainda falta uma interacao mais fluida e mais visual.
