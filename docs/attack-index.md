...
- [-] A7. Fechar Mesa ao Vivo
  Notas: `RPG-19` abriu o primeiro consumo real da `Forja de Sessao` dentro de `/app/play/[campaignId]`, puxando sessao ativa ou proxima sessao para o cockpit ao vivo com objetivo de mesa, contagem operacional e proximas cenas, depois adicionou quick inspect world-scoped com busca curta e drawer de detalhe, e agora permite disparar `reveals` preparados direto do cockpit da mesa. Ainda faltam integracao visual mais profunda e encaixe melhor entre narracao, combate e reveal.
