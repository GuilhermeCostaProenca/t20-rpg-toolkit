...
- [-] A7. Fechar Mesa ao Vivo
  Notas: `RPG-19` abriu o primeiro consumo real da `Forja de Sessao` dentro de `/app/play/[campaignId]`, puxando sessao ativa ou proxima sessao para o cockpit ao vivo com objetivo de mesa, contagem operacional e proximas cenas, e agora tambem quick inspect world-scoped dentro da propria mesa com busca curta, entidades em foco e drawer de detalhe. Ainda faltam integracao visual mais profunda e encaixe melhor entre narracao, combate e reveal.
