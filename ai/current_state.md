...
- Mesa ao Vivo esta funcional e madura; leitura de ficha foi reforcada, restando pendencia de handoff de fim de combate.
...
- Refinar fluxo de fim de combate no cockpit e validar em mesa real (A7).
...
1. Priorizar recorte curto para handoff final de fim de combate em A7 e validar em mesa real.
