...
- [ ] [A8] Fechar busca transversal de memoria com consolidacao final no attack-index.
...
- [ ] [A8-R4] Consolidar fechamento de A8 em docs executivos (`attack-index` + relatorio de merge readiness).
